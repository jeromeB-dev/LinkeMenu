<main id="establishments_custom" class="container-fluid">
	<h1 class="h2">Tableau de bord / <span class="h4">Personnalisation établissement(s) : </span></h1>
							...
							<div class="card-body">
									...
									<div class="col h5 p-0">
										...
										<p class="h6 font-weight-normal">
											La carte de cet établissement contient <span
												class=" h5 text-info"><?=date('Y')?></span> catégorie(s)
										</p>
										<a class="d-block h6 font-italic text-success"
								...
								<div class="row mb-3">
									...
									<div class="col h5 p-0">
										...
										<p class="h6 font-weight-normal">
											La carte de cet établissement contient <span
												class=" h5 text-info"><?=date('Y')?></span> produit(s)
										</p>
										<a class="d-block h6 font-italic text-success"
